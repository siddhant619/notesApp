...
export class NotesService {
  notes: Note[]=[
    ...
    new Note(1,'f', '','red', new Date("2022-09-23"),[], false),
    
    new Note(1,'f', '','', new Date("2022-09-23"),[], true),
    
    new Note(1,'Database systems', 'some new content afweffef ome new content afweffe ','red', new Date("2022-09-23"),
    [new Tag(1,'HTML'), new Tag(2,'CSS'),], true),
